...
export function SubObjetivoEmPortugalQ2({ objective, subObjectiveContent, setSelectedObjective }: SubObjetivoEmPortugalCheckBoxProps) {
   ...
   return (
      <>
         ...
         <FormLabel
            ...
            htmlFor='e-mail'
         >
            {subObjectiveContent.subQuestion}
         </FormLabel>
         <InputGroup>
            <RadioGroup>
               <VStack
               ...
               >
                  ...
                  <Radio
                     onChange={handleCheckboxChange}
                     value={subObjectiveContent.subAlternative}
                  >
                     {subObjectiveContent.subAlternative}
                  </Radio>
